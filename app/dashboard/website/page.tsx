...
import { ChevronDown, ChevronUp, Eye, EyeOff, GripVertical, Monitor, RotateCcw, Save, Smartphone } from "lucide-react";
      ...
      <div className="website-editor-layout">
        <div className={cn("section-list-panel", mobileTab !== "edit" && "mobile-hidden")}>
          ...
          <div className="section-editor">
            ...
            {activeId === "hero" && <Field label="Hero label"><input value={`${state.business.type} · ${state.business.city}`} onChange={() => {}} readOnly /></Field>}
