...
const features = [
  { icon: LayoutTemplate, title: "Niche-perfect websites", body: "Choose a polished template made for food businesses and customize the details—without ever breaking the design." },
  ...
  { icon: FileText, title: "A lightweight food-business CRM", body: "Keep every lead, note, and follow-up together from first inquiry to booked event." },
...
const plans = [
  { name: "Starter", price: "₪149", description: "For new food businesses ready to look established.", features: ["Professional website", "Custom domain support", "Up to 30 menu items", "Quote request form", "WhatsApp button"] },
  ...
  { name: "Pro", price: "₪449", description: "For established food operations.", features: ["Everything in Business", "Online deposits — Coming soon", "Automated quotes — Coming soon", "Multiple team members — Coming soon", "Priority support"] },
];
    ...
    <main className="marketing-page">
      ...
      <section className="hero-section">
        <div className="hero-copy container">
          <span className="eyebrow"><CircleCheck size={15} /> Built exclusively for food businesses</span>
          <h1>Your food business website, menu, and leads—<em>all in one place.</em></h1>
          <p>Launch a professional website for your food business, display your menus, and receive detailed customer requests without dealing with complicated website builders.</p>
        ...
        <div className="hero-showcase container">
          <div className="browser-frame">
            ...
            <div className="browser-content">
              <img src={sizedImage("https://images.unsplash.com/photo-1555244162-803834f70033", 1600)} alt="Elegant dining table" width={1600} height={900} fetchPriority="high" decoding="sync" />
              <div className="browser-overlay"><small>OLIVE &amp; EMBER</small><h2>Gather beautifully.<br />Dine memorably.</h2><p>Elegant kosher cuisine for unforgettable gatherings in Miami.</p><span className="demo-button">Plan your event</span></div>
            </div>
          </div>
      ...
      <section className="brand-strip"><div className="container"><span>Designed for</span><strong>Private chefs</strong><i /> <strong>Caterers</strong><i /> <strong>Restaurants</strong><i /> <strong>Bakeries &amp; food trucks</strong></div></section>

      <section id="features" className="section container">
        <div className="section-heading split-heading"><div><span className="eyebrow plain">One focused workspace</span><h2>Everything your food business needs online.</h2></div><p>ServeSite replaces the patchwork of a generic website builder, PDF menus, and scattered inquiry emails with one elegant system.</p></div>
      ...
      <section className="how-section">
        <div className="container">
          ...
          <div className="steps">{[
            ...
            ["02", "Choose your look", "Select a food-first template, then tune colors, typography, imagery, and content."],
            ["03", "Publish and grow", "Go live on your demo URL and manage detailed customer requests from one dashboard."],
      ...
      <section className="faq-section container">
        ...
        <div className="faq-list">{[
          ["Do I need design or technical experience?", "Not at all. ServeSite gives you controlled, food-specific options so you can personalize your site without managing layouts or code."],
      ...
      <section className="final-cta"><div className="container"><span className="eyebrow">Your next event could start here</span><h2>A better website. Better inquiries.<br />More memorable events.</h2><LinkButton href="/onboarding">Create your website <ArrowRight size={17} /></LinkButton></div></section>

      <footer className="marketing-footer container"><BrandMark /><p>Websites and lead management, purpose-built for food businesses.</p><div><Link href="/login">Log in</Link><a href="#pricing">Pricing</a><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div><small>© 2026 ServeSite. Demo product prototype.</small></footer>
    </main>
  );
}
