...
export default function PreviewPage() {
  ...
  const updateSection = (patch: Partial<NonNullable<typeof selected>>) => setState(current => ({ ...current, sections: current.sections.map(section => section.id === selectedId ? { ...section, ...patch } : section) }));
  return (
